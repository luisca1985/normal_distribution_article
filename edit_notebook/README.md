...
```bash
git clone git@github.com:luisca1985/normal_distribution_article.git
```
...
```bash
jupyter nbconvert --execute --to markdown edit_notebook/normal_distribution.ipynb --output-dir . --output README.md
```
